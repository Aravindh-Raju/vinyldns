...
class SharedZoneTestContext(object):
    ...
    def setup(self):
        ...
        try:
            ok_group = {
                ...
                "email": f"ok{partition_id}@test.com",
            ...
            dummy_group = {
                ...
                "email": f"dummy{partition_id}@test.com",
                "description": "this is a description",
                "members": [{"id": "dummy"}],
                "admins": [{"id": "dummy"}]
            }
            ...
            shared_record_group = {
                ...
                "email": f"record{partition_id}@test.com",
                "description": "this is a description",
            ...
            history_group = {
                ...
                "email": f"history{partition_id}@test.com",
                "description": "this is a description",
            ...
            ip6_reverse_zone_change = self.ok_vinyldns_client.create_zone(
                {
                    ...
                    "email": f"ip6reverse{partition_id}@test.com",
                    "shared": False,
                    "adminGroupId": self.ok_group["id"],
                    "isTest": True,
                    "connection": {
            ...
            ip6_16_nibble_zone_change = self.ok_vinyldns_client.create_zone(
                {
                    ...
                    "email": f"ip6nibble{partition_id}@test.com",
                    "shared": False,
                    "adminGroupId": self.ok_group["id"],
                    "isTest": True,
            ...
            ip4_reverse_zone_change = self.ok_vinyldns_client.create_zone(
                {
                    ...
                    "email": f"ip4reverse{partition_id}@test.com",
                    "shared": False,
                    "adminGroupId": self.ok_group["id"],
                    "isTest": True,
                    "connection": {
            ...
            classless_base_zone_change = self.ok_vinyldns_client.create_zone(
                {
                    ...
                    "email": f"ip4classless{partition_id}@test.com",
                    "shared": False,
                    "adminGroupId": self.ok_group["id"],
                    "isTest": True,
                    "connection": {
            ...
            classless_zone_delegation_change = self.ok_vinyldns_client.create_zone(
                {
                    ...
                    "email": f"classless{partition_id}@test.com",
                    "shared": False,
                    "adminGroupId": self.ok_group["id"],
                    "isTest": True,
                    "connection": {
            ...
            system_test_zone_change = self.ok_vinyldns_client.create_zone(
                {
                    ...
                    "email": "system-test{partition_id}@test.com",
                    "shared": False,
                    "adminGroupId": self.ok_group["id"],
                    "isTest": True,
                    "connection": {
            ...
            parent_zone_change = self.ok_vinyldns_client.create_zone(
                {
                    ...
                    "email": f"parent{partition_id}@test.com",
                    "shared": False,
                    "adminGroupId": self.ok_group["id"],
                    "isTest": True,
                    "acl": {
            ...
            ds_zone_change = self.ok_vinyldns_client.create_zone(
                {
                    ...
                    "email": f"ds{partition_id}@test.com",
                    "shared": False,
                    "adminGroupId": self.ok_group["id"],
                    "isTest": True,
                    "connection": {
            ...
            requires_review_zone_change = self.ok_vinyldns_client.create_zone(
                {
                    ...
                    "email": f"requires{partition_id}@test.com",
                    "shared": False,
                    "adminGroupId": self.ok_group["id"],
                    "isTest": True,
                    "backendId": "func-test-backend"
            ...
            shared_zone_change = self.support_user_client.create_zone(
                {
                    ...
                    "email": f"shared{partition_id}@test.com",
                    "shared": True,
    ...
    def init_group_activity(self):
        ...
        new_group = {
            "name": group_name,
            "email": f"testlist{self.partition_id}@test.com",
            "members": members,
            "admins": [{"id": "ok"}]
        }
