...
def test_list_group_members_success(shared_zone_test_context):
    ...
    try:
        new_group = {
            ...
            "email": "test_list_group_members_success@test.com",
...
def test_list_group_members_start_from(shared_zone_test_context):
    ...
    try:
        ...
        new_group = {
            ...
            "email": "test_list_group_members_start_from@test.com",
            "members": members,
            "admins": [{"id": "ok"}]
        }
...
def test_list_group_members_start_from_non_user(shared_zone_test_context):
    ...
    try:
        ...
        new_group = {
            ...
            "email": "test_list_group_members_start_from_non_user@test.com",
            "members": members,
            "admins": [{"id": "ok"}]
        }
...
def test_list_group_members_max_item(shared_zone_test_context):
    ...
    try:
        ...
        new_group = {
            ...
            "email": "test_list_group_members_max_item@test.com",
            "members": members,
            "admins": [{"id": "ok"}]
        }
...
def test_list_group_members_max_item_default(shared_zone_test_context):
    ...
    try:
        ...
        new_group = {
            ...
            "email": "test_list_group_members_max_item_default@test.com",
            "members": members,
            "admins": [{"id": "ok"}]
        }
...
def test_list_group_members_max_item_zero(shared_zone_test_context):
    ...
    try:
        ...
        new_group = {
            ...
            "email": "test_list_group_members_max_item_zero@test.com",
            "members": members,
            "admins": [{"id": "ok"}]
        }
...
def test_list_group_members_max_item_over_1000(shared_zone_test_context):
    ...
    try:
        ...
        new_group = {
            ...
            "email": "test_list_group_members_max_item_over_1000@test.com",
            "members": members,
            "admins": [{"id": "ok"}]
        }
...
def test_list_group_members_next_id_correct(shared_zone_test_context):
    ...
    try:
        ...
        new_group = {
            ...
            "email": "test_list_group_members_next_id_correct@test.com",
            "members": members,
            "admins": [{"id": "ok"}]
        }
...
def test_list_group_members_next_id_exhausted(shared_zone_test_context):
    ...
    try:
        ...
        new_group = {
            ...
            "email": "test_list_group_members_next_id_exhausted@test.com",
            "members": members,
            "admins": [{"id": "ok"}]
        }
...
def test_list_group_members_next_id_exhausted_two_pages(shared_zone_test_context):
    ...
    try:
        ...
        new_group = {
            ...
            "email": "test_list_group_members_next_id_exhausted_two_pages@test.com",
            "members": members,
            "admins": [{"id": "ok"}]
        }
...
def test_list_group_members_unauthed(shared_zone_test_context):
    ...
    try:
        new_group = {
            ...
            "email": "test_list_group_members_unauthed@test.com",
            "members": [{"id": "ok"}],
            "admins": [{"id": "ok"}]
        }
        saved_group = client.create_group(new_group, status=200)
